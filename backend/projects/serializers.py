...
class ProjectListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'start_date', 'end_date', 'budget', 'image',
            'created_at', 'created_by', 'accountability_count'
        ]
...
class AccountabilitySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'project', 'citizen', 'question', 'response',
            'status', 'created_at', 'updated_at', 'responded_by',
            'responded_at'
        ]
