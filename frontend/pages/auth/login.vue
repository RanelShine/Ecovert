...
<div class="min-h-screen flex items-start justify-center  pt-10 px-4 sm:px-6 lg:px-8">
    ...
    <div class="w-full max-w-md space-y-8">
      ...
      <form class="mt-2 bg-green-100 p-6 sm:p-7 rounded-xl space-y-6" @submit.prevent="login">
        <div class="space-y-4">
          <div>
            ...
            <input
              ...
              required
              v-model="email"
              class="appearance-none w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
